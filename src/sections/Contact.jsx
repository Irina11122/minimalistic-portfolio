    ...
    >
      ...
      >
        <input
          ...
          className="p-3 border rounded focus:ring-2 focus:ring-purple-400 dark:focus:ring-gold"
        />
        <input
          type="email"
          name="email"
        ...
        <textarea
          ...
          onChange={handleChange}
          className="p-3 border rounded h-32 resize-none focus:ring-2 focus:ring-purple-400 dark:focus:ring-gold"
        ></textarea>
        <button
          type="submit"
          className="bg-purple-500 dark:bg-gray-purple text-white py-3 rounded hover:bg-purple-600 transition-colors"
        >
          Send Message
        </button>
      </form>
